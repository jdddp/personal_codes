...
goalDir=osp.join(r'E:\vsCodes\personal_codes', 'test')
makeDirs(goalDir)
oldDir=r'E:\vsCodes\personal_codes\tools\classify_tool\projects\dogClasV1\dogV1\bige'
for i,imgname in enumerate(os.listdir(oldDir)):
    shutil.copy(osp.join(oldDir, imgname), goalDir)
